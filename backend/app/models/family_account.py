...
class FamilyAccount(Base):
    """Citizen account (legacy table name family_accounts retained for DB compatibility)."""
    ...
    sessions = relationship(
        "FamilySession", back_populates="family_account", cascade="all, delete-orphan"
    )
